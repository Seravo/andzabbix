...
class GraphListAdapterView extends LinearLayout {        

        public GraphListAdapterView(Context context,Graph graph ) {
            super(context);
            ...
            garphControl.setText( graph.getName());
...
public class GraphListAdapter extends BaseAdapter {
    ...
    public GraphListAdapter(Context context, List<Graph> graphList ) { 
    ...
    public View getView(int position, View convertView, ViewGroup parent) { 
        ...
        return new GraphListAdapterView(this.context, graph );
    }
