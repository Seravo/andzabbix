...
OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.checkprefs);
        
        EditTextPreference activetriggertime = (EditTextPreference) findPreference("activetriggertime");
        activetriggertime.setSummary("Custom time period for check active triggers. Show active triggers fo last: "+activetriggertime.getText()+" min");
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
    	...
    	if (key.equals("activetriggertime")) {
	    	EditTextPreference activetriggertime = (EditTextPreference) findPreference("activetriggertime");
	        activetriggertime.setSummary("Custom time period for check active triggers. Show active triggers changed status for last: "+activetriggertime.getText()+" min");
    	}
